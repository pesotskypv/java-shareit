...
public class BookingServiceImplIntegrationTest {
    ...
    void createBooking() {
        ...
        BookingDto actualBookingDto = bookingService.createBooking(dbUser1.getId(), bookingDtoReq);
    ...
    void approveOrRejectBooking() {
        ...
        BookingDto actualBookingDto = bookingService.approveOrRejectBooking(user2.getId(), dbBooking.getId(),
                true);
    ...
    void getBookingById() {
        ...
        BookingDto actualBookingDto = bookingService.getBookingById(user2.getId(), dbBooking.getId());
    ...
    void getAllBookingsByUserId() {
        ...
        List<BookingDto> actualBookingsDto = bookingService.getAllBookingsByUserId(user1.getId(),"ALL");
    ...
    void getAllBookingsForAllItemsByUserId() {
        ...
        List<BookingDto> actualBookingsDto = bookingService.getAllBookingsForAllItemsByUserId(user2.getId(),"ALL");
