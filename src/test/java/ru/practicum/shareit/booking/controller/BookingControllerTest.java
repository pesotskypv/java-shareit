...
public class BookingControllerTest {
    ...
    void approveOrRejectBooking() throws Exception {
        ...
        Mockito.when(bookingService.approveOrRejectBooking(bookingId, approved, userId)).thenReturn(bookingDto);
        ...
        Mockito.verify(bookingService, Mockito.times(1)).approveOrRejectBooking(bookingId,
                approved, userId);
        Mockito.verifyNoMoreInteractions(bookingService);
    }
